        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Mithun (Gemini) Puja</h1>
                    <p>Attain intelligence, fast communication, business success, and adaptability and invite divine blessings into your life. Budh (Mercury) governs Gemini; balancing its energy unlocks profound cosmic benefits.</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Mithun (Gemini) Puja?</h2>
                    <p>Mithun (Gemini) Puja is a powerful Vedic ritual dedicated to Lord Ganesha and Budh Dev and Budh (Mercury). As the sign of Gemini, it perfectly channels the energy of intelligence, fast communication, business success, and adaptability.</p>
                    <p>When Budh (Mercury) is weak or afflicted in your horoscope, it can cause significant obstacles. This tailored ritual pacifies these malefic placements.</p>
                    <p>The puja is traditionally performed to invoke purely auspicious energies, featuring specific Budh (Mercury) Beej Mantras and sacred offerings to clear karmic blockages.</p>
                </div>
            </section>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Mithun (Gemini) Puja?</h2>
                    <div className="sp-why-grid">
                        <div className="sp-why-card">
                            <h4>💫 Astrological Alignment</h4>
                            <p>Corrects doshas and negative transits directly impacting the Gemini moon sign or ascendant.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🎯 Career Breakthroughs</h4>
                            <p>Removes unseen obstacles severely blocking your professional and financial intelligence, fast communication, business success, and adaptability.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🧘 Inner Peace</h4>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Mithun (Gemini) Puja</h2>
                ...
                <div className="sp-container">
                    ...
                    <div className="sp-stairs">
                        {[
                            ...
                            { num: 2, icon: '🙏', title: 'Avahana', sub: 'Invoking Lord Ganesha and Budh Dev with ancient Vedic mantras' },
                            { num: 3, icon: '🌸', title: 'Shodashopachar', sub: 'Offering green durva grass and tulsi and sacred items' },
                            { num: 4, icon: '📖', title: 'Mantra Japa', sub: 'Chanting Om Bram Brim Braum Sah Budhaya Namah' },
                            { num: 5, icon: '🔥', title: 'Sacred Havan', sub: 'Fire ritual with green moong and specific oblations' },
                            { num: 6, icon: '💧', title: 'Shanti Path', sub: 'Vedic prayers to stabilize the intellectual and communicative energy' },
                            { num: 7, icon: '🎁', title: 'Aarti & Prasad', sub: 'Sending you energized bronze/emerald and divine blessings' },
                        ].map((s, i) => (
