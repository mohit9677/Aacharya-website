...
const PUJA_NAME = 'Mithun (Gemini) Puja';
...
const pkgList = [
  {
    id:        'saral',
    name:      'Saral',
    subtitle:  'Essential Mithun Puja',
    priceText: '₹ 5,100',
    price:     5100,
    pandits:   1,
    japa:      '11,000 mantras',
...
const benefits = [
  {
    "icon": Shield,
    "title": "Removes Mercury-related doshas and Budh Graha",
    "desc": "Removes Mercury-related doshas and Budh Graha aﬄictions, restoring clear communication, eliminating misunderstandings, and harmonizing all personal and professional relationships."
  },
  {
    "icon": Heart,
    "title": "Brings tremendous success in business",
    "desc": "Brings tremendous success in business, trade, commerce, and ﬁnance by activating Mercury's powerful wealth-generating and deal-making energies."
  },
  {
    "icon": Briefcase,
    "title": "Enhances writing skills",
    "desc": "Enhances writing skills, oratory, media presence, and literary talents, opening gateways to fame and recognition in communication ﬁelds."
  },
  {
    "icon": Users,
    "title": "Heals nervous system disorders",
    "desc": "Heals nervous system disorders, skin ailments, and speech problems by drawing Mercury's divine healing energy into the body. Creates mental clarity, reduces anxiety and stress, and helps the native focus scattered energy into concentrated, productive life force."
  }
]
;
...
const steps = [
  {
    "n": "01",
    "title": "clothing",
    "desc": "clothing — Mercury's power is strongest at dawn."
  },
  {
    "n": "02",
    "title": "Mercury energy is your cosmic antenna.",
    "desc": "Mercury energy is your cosmic antenna."
  },
  {
    "n": "03",
    "title": "absolutely adores the emerald spectrum of",
    "desc": "absolutely adores the emerald spectrum of nature."
  },
  {
    "n": "04",
    "title": "intellect from within.",
    "desc": "intellect from within."
  },
  {
    "n": "05",
    "title": "sharp with every single repetition.",
    "desc": "sharp with every single repetition."
  },
  {
    "n": "06",
    "title": "with divine intelligence.",
    "desc": "with divine intelligence."
  },
  {
    "n": "07",
    "title": "chakra, Mercury's seat of cosmic intelligence.",
    "desc": "chakra, Mercury's seat of cosmic intelligence."
  },
  {
    "n": "08",
    "title": "tenfold blessings in return.",
    "desc": "tenfold blessings in return."
  },
  {
    "n": "09",
    "title": "astonishing speed and eﬀectiveness.",
    "desc": "astonishing speed and eﬀectiveness."
  }
];
const whyPoints = [
  "People perform Mithuna Rashi Puja to sharpen Mercury's intellectual powers, granting brilliant clarity of thought, exceptional communication skills, and removing mental confusion that blocks success in competitive ﬁelds.",
  "This puja is performed by students and scholars to gain extraordinary academic excellence, sharp memory, outstanding analytical abilities, and success in competitive examinations and intellectual pursuits.",
  "Businesspeople, traders, and merchants perform this puja to attract commercial success, as Mercury governs trade, negotiations, and ﬁnancial transactions, blessing them with exceptional deal-making skills.",
  "When Mercury is retrograde or aﬄicted in the horoscope, this puja is performed to stabilize its energy, preventing miscommunications, travel disruptions, and technology failures in the native's life.",
  "Writers, journalists, orators, and media professionals perform this puja to receive divine inspiration, ﬂuent expression, and the gift of captivating language that resonates powerfully with their audiences. People suﬀering from nervous disorders, anxiety, skin problems, or speech impediments — Mercury-ruled health areas — perform this puja to seek divine healing and full restoration of health."
];
...
export default function MithunPujaPage() {
    ...
    <div className="mesh-puja-theme">
      <section className="mp-hero">
        <div className="mp-hero__bg">
          <img src={heroImg} alt="Mithun (Gemini) Puja hero" />
          ...
          <div className="mp-hero__inner">
            <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration:0.8 }}>
              ...
              <h1 className="mp-serif mp-hero__title">
                Awaken Gemini.<br />
                <span className="mp-hero__title-accent">Align Mithun.</span>
              </h1>
              <p className="mp-hero__desc mp-sans">
                Mithuna Rashi Puja is a vibrant V edic ritual performed for those born under the Gemini zodiac sign. Governed by Mercury (Budh) — the planet of intellect, communication, and commerce — this puja invokes the blessings of Lord Vishnu and Budh Dev, sharpening the…
              </p>
          ...
          <div className="mp-about__grid">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.8, delay:0.1 }}>
              ...
              <h2 className="mp-section-title">
                What is the<br /><span style={{ fontStyle:'italic' }}>Mithun Puja?</span>
              </h2>
              <div className="mp-about__body mp-sans">
                <p>Mithuna Rashi Puja is a vibrant V edic ritual performed for those born under the Gemini zodiac sign. Governed by Mercury (Budh) — the planet of intellect, communication, and commerce — this puja invokes the blessings of Lord Vishnu and Budh Dev, sharpening the mind, enhancing communication skills, and attracting extraordinary success in trade and intellectual pursuits.</p>
                <p>Mithuna Rashi Puja is a sacred V edic ritual performed to strengthen the inﬂuence of Mercury (Budh) — the cosmic planet of intelligence, eloquence, and commerce — for individuals born under the Gemini zodiac sign. In V edic astrology, Gemini is an air sign ruled by the ever-youthful and razor-sharp planet Mercury, which governs communication, wit, analytical thinking, writing, trading, and all forms of intellectual expression. Gemini natives are naturally gifted with brilliant minds, charming personalities, and an insatiable curiosity about the world. However, they may also struggle with indecisiveness, scattered energy, nervous tension, and diﬃculties in focusing their extraordinary mental powers on a single goal. The Mithuna Rashi Puja is a divine solution to align Mercury's energy perfectly with the native's life purpose. This puja is traditionally performed on Wednesdays — Mercury's sacred day — with green-colored oﬀerings, emerald green ﬂowers, moong dal, and green vegetables. Sacred Budh mantras and Vishnu Sahasranama are chanted with focused concentration. The ritual puriﬁes Mercury's energy in the birth chart, clearing mental fog, enhancing decision-making, boosting communication powers to extraordinary levels, and blessing the native with success in education, business negotiations, writing, media, and all ﬁelds requiring sharp intellect and silver-tongued communication.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="benefits" className="mp-section mp-section--muted" style={{ position:'relative' }}>
        ...
        <div className="mp-container" style={{ position:'relative' }}>
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-text-center mp-max-2xl mp-mb-16">
            ...
            <p className="mp-section-sub">People perform Mithuna Rashi Puja to sharpen Mercury's intellectual powers, granting brilliant clarity of thought, exceptional communication skills, and removing mental confusion that blocks success in competitive ﬁelds.</p>
          </motion.div>
        ...
        <div className="mp-container">
          <div className="mp-process__grid">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-process__sticky">
              ...
              <p className="mp-section-sub" style={{ marginBottom:'2rem' }}>clothing — Mercury's power is strongest at dawn.</p>
