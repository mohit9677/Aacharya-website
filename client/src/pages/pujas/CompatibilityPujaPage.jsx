...
const PUJA_NAME = 'Compatibility (Kundli Milan) Puja'
const API_BASE = import.meta.env.VITE_API_URL || 'http://localhost:5000'

const PACKAGES = [
  {
    id: 'basic',
    name: 'Saral Compatibility (Kundli Milan) Puja',
    price: 5100,
  ...
  {
    id: 'standard',
    name: 'Shubh Compatibility (Kundli Milan) Puja',
    price: 11100,
  ...
  {
    id: 'premium',
    name: 'Divya Compatibility (Kundli Milan) Puja Mahotsav',
    price: 21100,
...
const BENEFITS = [
  {
    "icon": "📜",
    "title": "Improved Match Quality",
    "desc": "Strengthens compatibility dimensions indicated in kundli analysis."
  },
  {
    "icon": "🪔",
    "title": "Dosha Relief",
    "desc": "Reduces harmful impact of specific marriage-related doshas."
  },
  {
    "icon": "🤝",
    "title": "Mutual Understanding",
    "desc": "Enhances cooperation and patience in difficult phases."
  },
  {
    "icon": "💠",
    "title": "Stable Married Life",
    "desc": "Builds a stronger foundation for long-term marital happiness."
  },
  {
    "icon": "🌼",
    "title": "Family Alignment",
    "desc": "Encourages smoother adjustment between both family systems."
  },
  {
    "icon": "✨",
    "title": "Auspicious Beginning",
    "desc": "Invokes sacred blessings for a healthy and prosperous union."
  }
]
const STEPS = [
  {
    "n": "01",
    "title": "Kundli Sankalp",
    "text": "Both charts are spiritually dedicated for compatibility harmonization."
  },
  {
    "n": "02",
    "title": "Ganesh Pujan",
    "text": "Obstacle removal for smooth marriage progression and clear decisions."
  },
  {
    "n": "03",
    "title": "Guna Samya Mantras",
    "text": "Mantras for balancing psychological and emotional compatibility factors."
  },
  {
    "n": "04",
    "title": "Dosha Nivaran Vidhi",
    "text": "Targeted rituals for Nadi, Bhakoot, and Mangal concerns."
  },
  {
    "n": "05",
    "title": "Havan for Marriage Yoga",
    "text": "Sacred fire offerings to activate auspicious married-life combinations."
  },
  {
    "n": "06",
    "title": "Ashirwad & Muhurat Guidance",
    "text": "Final blessings and guidance for next marriage steps."
  }
]
const TESTIMONIALS = [
  {
    "name": "Harsh & Kavya",
    "city": "Lucknow",
    "text": "We felt much more confident after this puja despite initial kundli concerns."
  },
  {
    "name": "Vaani",
    "city": "Surat",
    "text": "The ritual and guidance made our engagement process very smooth."
  },
  {
    "name": "Rajat & Nidhi",
    "city": "Bhopal",
    "text": "Family anxieties reduced and the atmosphere became positive."
  }
]
...
export default function CompatibilityPujaPage() {
    ...
    <div className="vp-page">
      <header className="vp-header">
        <div className="vp-container vp-nav">
          <a href="#top" className="vp-brand">🕉 Kundli Milan Shanti</a>
      ...
      <section className="vp-hero" id="top">
        <img src={heroImage} alt="Compatibility (Kundli Milan) Puja" className="vp-hero-bg" />
        ...
        <div className="vp-container vp-hero-content">
          <p className="vp-dev">Kundli Milan Shanti</p>
          <h1>Compatibility (Kundli Milan) Puja</h1>
          <p className="vp-tagline">Aligning two energies for a stable, prosperous, and spiritually compatible marriage.</p>
      ...
      <section id="about" className="vp-section vp-soft">
        <div className="vp-container vp-about-grid">
          <div>
            ...
            <h2>What is Compatibility (Kundli Milan) Puja?</h2>
            <p>Compatibility Puja is performed when couples seek deeper astrological harmony before marriage, especially when guna mismatch or dosha concerns are present.</p>
            <p>It strengthens compatibility factors and reduces friction points indicated in kundli matching reports.</p>
      ...
      <section className="vp-section vp-why">
        <div className="vp-container">
          ...
          <h2 className="center">Why People Perform Compatibility (Kundli Milan) Puja</h2>
      ...
      <section className="vp-section" id="benefits">
        <div className="vp-container">
          ...
          <h2 className="center">Blessings of Compatibility (Kundli Milan) Puja</h2>
      ...
      <section className="vp-section" id="book">
        <div className="vp-container vp-book">
          ...
          <h2 className="center">Book Your Compatibility (Kundli Milan) Puja</h2>
          {status === 'success' ? (
      ...
      <footer className="vp-footer">
        <div className="vp-container">
          ...
          <h3>Kundli Milan Shanti</h3>
          <p>Authentic Vedic ceremonies performed by learned pandits, rooted in scripture and tradition.</p>
          <small>© {new Date().getFullYear()} Kundli Milan Shanti. All blessings reserved.</small>
        </div>
      </footer>
    </div>
  )
