...
const PUJA_NAME = "Negative Energy Removal Puja"
...
const BENEFITS = [
  { icon: <FiStar />, title: "Complete Negative Clearing", desc: "Removes accumulated negativity from aura and surroundings." },
  { icon: <FiHeart />, title: "Emotional Lightness", desc: "Relieves anxiety, heaviness, and unexplained emotional pressure." },
  { icon: <FiSun />, title: "Luck Cycle Reset", desc: "Breaks repeated misfortune by clearing energetic root causes." },
  { icon: <FiShield />, title: "Home Becomes Sanctuary", desc: "Purifies home and restores uplifting protective vibration." },
  { icon: <FiHeart />, title: "Mental Clarity Restored", desc: "Reduces fog, stress, and depressive heaviness with renewed clarity." },
  { icon: <FiStar />, title: "Ancestral Burden Release", desc: "Clears inherited karmic patterns and stagnant family residue." }
]
...
const STEPS = [
  {
    "n": "01",
    "title": "Energy Field Reading",
    "text": "Priest identifies where and how deeply negativity has settled."
  },
  {
    "n": "02",
    "title": "Sacred Smoke Purification",
    "text": "Loban and guggul smoke sweeps out stagnant energetic residue."
  },
  {
    "n": "03",
    "title": "Purification Sankalp",
    "text": "Divine witnesses are invoked for complete shuddhi and reset."
  },
  {
    "n": "04",
    "title": "Kali Beej & Mahamrityunjaya Japa",
    "text": "Intense mantra rounds remove deeper layers of darkness."
  },
  {
    "n": "05",
    "title": "Elemental Cleansing Havan",
    "text": "Camphor, neem, cloves, and sesame offerings clear multi-source negativity."
  },
  {
    "n": "06",
    "title": "Home Grid Sealing",
    "text": "Gangajal-salt sealing and aarti lock purified protective frequencies."
  }
]
        ...
        <div className="mm-page">
            ...
            <section className="mm-hero" style={{ '--mm-hero-image': `url(${heroImage})` }}>
                ...
                <div className="mm-hero-content">
                    ...
                    <h1>Negative Energy Removal Puja <span>Puja</span></h1>
                    <p className="mm-quote">Complete Energetic Reset for Life and Home</p>
            ...
            <section className="mm-mantra">
                <h2>ॐ क्रीं कालिकायै नमः । ॐ नमः शिवाय ।</h2>
                <p>Salutations to Goddess Kali and Lord Shiva for destruction of darkness and purification into divine light.</p>
            </section>
            ...
            <section className="mm-section">
                <div className="mm-container mm-about">
                    <div>
                        ...
                        <h2>What is Negative Energy Removal Puja?</h2>
                        <p>
            ...
            <footer className="mm-footer">
                ...
                <p>May every shadow dissolve and your life shine in divine light.</p>
