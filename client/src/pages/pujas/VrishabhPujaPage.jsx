...
import heroImg from '../../Marriage/taurus.webp';
import yantraImg from '../../Marriage/taurus (2).webp';
import havanImg from '../../Marriage/taurus.webp';
import './MeshPujaStyle.css';

const PUJA_ID   = 'vrishabh-puja';
const PUJA_NAME = 'Vrishabh (Taurus) Puja';
...
const pkgList = [
  {
    id:        'saral',
    name:      'Saral',
    subtitle:  'Essential Vrishabh Puja',
    priceText: '₹ 5,100',
    price:     5100,
    pandits:   1,
    japa:      '11,000 mantras',
...
const benefits = [
  {
    "icon": Shield,
    "title": "Blesses the native with lasting wealth",
    "desc": "Blesses the native with lasting wealth, material prosperity, and ﬁnancial stability by activating V enus's most powerful and beneﬁc cosmic inﬂuence."
  },
  {
    "icon": Heart,
    "title": "Enhances love life and marital harmony",
    "desc": "Enhances love life and marital harmony, dissolving conﬂicts and attracting genuine, deep aﬀection, emotional fulﬁlment, and romantic bliss."
  },
  {
    "icon": Briefcase,
    "title": "Boosts creative talents",
    "desc": "Boosts creative talents, reﬁned aesthetic sense, and artistic brilliance, opening grand doors to fame and professional recognition."
  },
  {
    "icon": Users,
    "title": "Improves physical health",
    "desc": "Improves physical health, especially conditions related to throat, skin, hormonal imbalance, and the female reproductive system."
  },
  {
    "icon": Flame,
    "title": "Calms anxiety and mental restlessness",
    "desc": "Calms anxiety and mental restlessness, ﬁlling the native's life with inner peace, contentment, and beautiful emotional stability."
  },
  {
    "icon": Sparkles,
    "title": "Accelerates business growth and career success",
    "desc": "Accelerates business growth and career success, especially in fashion, art, beauty, luxury, hospitality, and entertainment industries."
  }
]
;
...
const steps = [
  {
    "n": "01",
    "title": "geometric gateway to V enus energy.",
    "desc": "geometric gateway to V enus energy."
  },
  {
    "n": "02",
    "title": "sends your prayers soaring to the",
    "desc": "sends your prayers soaring to the heavens."
  },
  {
    "n": "03",
    "title": "through cosmic darkness on your behalf.",
    "desc": "through cosmic darkness on your behalf."
  },
  {
    "n": "04",
    "title": "Lakshmi are deeply pleased by white",
    "desc": "Lakshmi are deeply pleased by white oﬀerings."
  },
  {
    "n": "05",
    "title": "vibration entering every cell of your",
    "desc": "vibration entering every cell of your being."
  },
  {
    "n": "06",
    "title": "unlock the inﬁnite treasury of Goddess",
    "desc": "unlock the inﬁnite treasury of Goddess Lakshmi."
  },
  {
    "n": "07",
    "title": "corner of your home with blessings.",
    "desc": "corner of your home with blessings."
  },
  {
    "n": "08",
    "title": "ﬂow abundantly through selﬂess giving.",
    "desc": "ﬂow abundantly through selﬂess giving."
  },
  {
    "n": "09",
    "title": "your love life, ﬁnances, and beauty",
    "desc": "your love life, ﬁnances, and beauty radiate like never before!"
  }
];
const whyPoints = [
  "People perform Vrishabha Rashi Puja to strengthen V enus's positive cosmic inﬂuence, inviting abundant love, beauty, and material wealth while eliminating planetary doshas causing obstacles in daily life.",
  "This puja is performed to overcome relationship challenges and marital conﬂicts, as V enus governs love and harmony, blessing Taurus natives with fulﬁlling, aﬀectionate, and long-lasting romantic partnerships. Financial stability and wealth magnetism are key motivations, as a well-placed and pleased V enus showers the native with prosperity, luxury, business success, and unending material abundance.",
  "Individuals facing health issues related to throat, kidneys, skin, or reproductive organs V enus-ruled body parts — perform this puja seeking divine healing, recovery, and lasting physical wellness.",
  "Artists, musicians, fashion designers, and all creative professionals born under Taurus perform this puja to amplify their artistic genius, aesthetic vision, and professional recognition in creative ﬁelds.",
  "When V enus is debilitated, combust, or severely aﬄicted in the birth chart, this puja is performed to neutralize maleﬁc eﬀects and restore cosmic balance in the native's life."
];
...
export default function VrishabhPujaPage() {
    ...
    <div className="mesh-puja-theme">
      <section className="mp-hero">
        <div className="mp-hero__bg">
          <img src={heroImg} alt="Vrishabh (Taurus) Puja hero" />
          ...
          <div className="mp-hero__inner">
            <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration:0.8 }}>
              ...
              <h1 className="mp-serif mp-hero__title">
                Awaken Taurus.<br />
                <span className="mp-hero__title-accent">Align Vrishabh.</span>
              </h1>
              <p className="mp-hero__desc mp-sans">
                Vrishabha Rashi Puja is a sacred V edic ritual performed for those born under the Taurus zodiac sign. Governed by the planet V enus (Shukra), this divine puja invokes the blessings of Goddess Lakshmi and Shukra Dev, channeling energies of prosperity, love, bea…
              </p>
          ...
          <div className="mp-about__grid">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.8, delay:0.1 }}>
              ...
              <h2 className="mp-section-title">
                What is the<br /><span style={{ fontStyle:'italic' }}>Vrishabh Puja?</span>
              </h2>
              <div className="mp-about__body mp-sans">
                <p>Vrishabha Rashi Puja is a sacred V edic ritual performed for those born under the Taurus zodiac sign. Governed by the planet V enus (Shukra), this divine puja invokes the blessings of Goddess Lakshmi and Shukra Dev, channeling energies of prosperity, love, beauty, and artistic abundance into the native's life.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="benefits" className="mp-section mp-section--muted" style={{ position:'relative' }}>
        ...
        <div className="mp-container" style={{ position:'relative' }}>
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-text-center mp-max-2xl mp-mb-16">
            ...
            <p className="mp-section-sub">People perform Vrishabha Rashi Puja to strengthen V enus's positive cosmic inﬂuence, inviting abundant love, beauty, and material wealth while eliminating planetary doshas causing obstacles in daily life.</p>
          </motion.div>
        ...
        <div className="mp-container">
          <div className="mp-process__grid">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-process__sticky">
              ...
              <p className="mp-section-sub" style={{ marginBottom:'2rem' }}>geometric gateway to V enus energy.</p>
