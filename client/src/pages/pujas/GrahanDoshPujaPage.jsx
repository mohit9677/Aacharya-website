        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Grahan Dosh Puja</h1>
                    <p>[Hero description for Grahan Dosh Puja will go here. This provides the primary benefits and calling.]</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Grahan Dosh Puja?</h2>
                    <p>[Detailed description of what Grahan Dosh Puja is, its Vedic significance, and the main deity or cosmic energy involved. Add specific context here later.]</p>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Grahan Dosh Puja?</h2>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Grahan Dosh Puja</h2>
