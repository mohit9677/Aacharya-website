        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Singh (Leo) Puja</h1>
                    <p>Attain leadership, immense confidence, health, and authority and invite divine blessings into your life. Surya (Sun) governs Leo; balancing its energy unlocks profound cosmic benefits.</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Singh (Leo) Puja?</h2>
                    <p>Singh (Leo) Puja is a powerful Vedic ritual dedicated to Lord Surya Narayana and Surya (Sun). As the sign of Leo, it perfectly channels the energy of leadership, immense confidence, health, and authority.</p>
                    <p>When Surya (Sun) is weak or afflicted in your horoscope, it can cause significant obstacles. This tailored ritual pacifies these malefic placements.</p>
                    <p>The puja is traditionally performed to invoke purely auspicious energies, featuring specific Surya (Sun) Beej Mantras and sacred offerings to clear karmic blockages.</p>
                </div>
            </section>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Singh (Leo) Puja?</h2>
                    <div className="sp-why-grid">
                        <div className="sp-why-card">
                            <h4>💫 Astrological Alignment</h4>
                            <p>Corrects doshas and negative transits directly impacting the Leo moon sign or ascendant.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🎯 Career Breakthroughs</h4>
                            <p>Removes unseen obstacles severely blocking your professional and financial leadership, immense confidence, health, and authority.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🧘 Inner Peace</h4>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Singh (Leo) Puja</h2>
                ...
                <div className="sp-container">
                    ...
                    <div className="sp-stairs">
                        {[
                            ...
                            { num: 2, icon: '🙏', title: 'Avahana', sub: 'Invoking Lord Surya Narayana with ancient Vedic mantras' },
                            { num: 3, icon: '🌸', title: 'Shodashopachar', sub: 'Offering red lotuses and water (Arghya) and sacred items' },
                            { num: 4, icon: '📖', title: 'Mantra Japa', sub: 'Chanting Om Hram Hrim Hraum Sah Suryaya Namah' },
                            { num: 5, icon: '🔥', title: 'Sacred Havan', sub: 'Fire ritual with wheat and specific wood' },
                            { num: 6, icon: '💧', title: 'Shanti Path', sub: 'Vedic prayers to stabilize the radiant and authoritative energy' },
                            { num: 7, icon: '🎁', title: 'Aarti & Prasad', sub: 'Sending you energized copper/ruby and divine blessings' },
                        ].map((s, i) => (
