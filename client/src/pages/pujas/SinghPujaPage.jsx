...
import heroImg from '../../Marriage/leo.webp';
import yantraImg from '../../Marriage/leo (2).webp';
import havanImg from '../../Marriage/leo (3).webp';
import './MeshPujaStyle.css';

const PUJA_ID   = 'singh-puja';
const PUJA_NAME = 'Singh (Leo) Puja';
...
const benefits = [
  {
    "icon": Shield,
    "title": "Opens doors to career success",
    "desc": "Opens doors to career success, promotions, government favor, and professional recognition, establishing the native as a respected authority ﬁgure. Strengthens the father-son relationship and brings blessings and guidance from paternal ﬁgures and powerful mentors."
  },
  {
    "icon": Heart,
    "title": "Heals heart ailments",
    "desc": "Heals heart ailments, improves eyesight, boosts immunity, and revitalizes the native's overall physical vitality and life energy. Burns away ego, pride, and arrogance, replacing them with divine dignity, noble character, and true solar wisdom."
  },
  {
    "icon": Briefcase,
    "title": "Blesses with fame",
    "desc": "Blesses with fame, public recognition, social status, and lasting honor that places the native in positions of great inﬂuence."
  }
]
;
...
const steps = [
  {
    "n": "01",
    "title": "carry immeasurable divine power speciﬁcally for",
    "desc": "carry immeasurable divine power speciﬁcally for Leo souls."
  },
  {
    "n": "02",
    "title": "watch the golden light ﬁll your",
    "desc": "watch the golden light ﬁll your outstretched hands and soul."
  },
  {
    "n": "03",
    "title": "golden ghee lamp lit in your",
    "desc": "golden ghee lamp lit in your honor."
  },
  {
    "n": "04",
    "title": "your prayers directly to the solar",
    "desc": "your prayers directly to the solar throne."
  },
  {
    "n": "05",
    "title": "Sun's invincible, lion-hearted golden ﬁre.",
    "desc": "Sun's invincible, lion-hearted golden ﬁre."
  },
  {
    "n": "06",
    "title": "cosmic lion, heard across all the",
    "desc": "cosmic lion, heard across all the fourteen worlds."
  },
  {
    "n": "07",
    "title": "lightning bolt of illumination from the",
    "desc": "lightning bolt of illumination from the cosmic solar court."
  },
  {
    "n": "08",
    "title": "generous, kingly giving with a thousand",
    "desc": "generous, kingly giving with a thousand times more in return."
  },
  {
    "n": "09",
    "title": "heartfelt blessings into your life.",
    "desc": "heartfelt blessings into your life."
  }
];
const whyPoints = [
  "People perform Simha Rashi Puja to strengthen the Sun's regal inﬂuence, gaining unshakeable authority, natural leadership qualities, and a magnetic charisma that commands respect from all directions.",
  "This puja is performed to achieve career advancement, government recognition, and professional fame, as a powerful Sun blesses the native with visibility, promotion, and outstanding worldly success.",
  "Individuals with weak Sun in the horoscope perform this puja to boost self- conﬁdence, eliminate self-doubt, and reclaim their inner royal identity and divine life purpose. People facing issues with their father, paternal ﬁgures, or government authorities perform this puja to heal these relationships and attract support from powerful, inﬂuential people in high positions.",
  "Those suﬀering from heart ailments, eye problems, bone issues, or low vitality — Sun- governed health areas — perform this puja for divine healing and robust physical energy.",
  "Politicians, executives, celebrities, and public ﬁgures perform this puja to maintain their prominence, expand their inﬂuence, protect their reputation, and receive continued blessings of fame."
];
...
export default function SinghPujaPage() {
    ...
    <div className="mesh-puja-theme">
      <section className="mp-hero">
        <div className="mp-hero__bg">
          <img src={heroImg} alt="Singh (Leo) Puja hero" />
          ...
          <div className="mp-hero__inner">
            <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration:0.8 }}>
              ...
              <h1 className="mp-serif mp-hero__title">
                Awaken Leo.<br />
                <span className="mp-hero__title-accent">Align Singh.</span>
              </h1>
              <p className="mp-hero__desc mp-sans">
                Simha Rashi Puja is a majestic V edic ritual performed for those born under the Leo zodiac sign. Governed by the all-powerful Sun (Surya) — the king of all planets — this puja invokes Lord Surya and Lord Vishnu, crowning the native with supreme authority, radi…
              </p>
          ...
          <div className="mp-about__grid">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.8, delay:0.1 }}>
              ...
              <h2 className="mp-section-title">
                What is the<br /><span style={{ fontStyle:'italic' }}>Singh Puja?</span>
              </h2>
              <div className="mp-about__body mp-sans">
                <p>Simha Rashi Puja is a majestic V edic ritual performed for those born under the Leo zodiac sign. Governed by the all-powerful Sun (Surya) — the king of all planets — this puja invokes Lord Surya and Lord Vishnu, crowning the native with supreme authority, radiant conﬁdence, unshakeable leadership, and the golden ﬁre of royal success.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="benefits" className="mp-section mp-section--muted" style={{ position:'relative' }}>
        ...
        <div className="mp-container" style={{ position:'relative' }}>
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-text-center mp-max-2xl mp-mb-16">
            ...
            <p className="mp-section-sub">People perform Simha Rashi Puja to strengthen the Sun's regal inﬂuence, gaining unshakeable authority, natural leadership qualities, and a magnetic charisma that commands respect from all directions.</p>
          </motion.div>
        ...
        <div className="mp-container">
          <div className="mp-process__grid">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-process__sticky">
              ...
              <p className="mp-section-sub" style={{ marginBottom:'2rem' }}>carry immeasurable divine power speciﬁcally for Leo souls.</p>
