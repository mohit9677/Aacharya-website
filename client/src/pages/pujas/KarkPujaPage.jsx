        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Kark (Cancer) Puja</h1>
                    <p>Attain emotional peace, mental clarity, and domestic harmony and invite divine blessings into your life. Chandra (Moon) governs Cancer; balancing its energy unlocks profound cosmic benefits.</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Kark (Cancer) Puja?</h2>
                    <p>Kark (Cancer) Puja is a powerful Vedic ritual dedicated to Lord Shiva and Chandra Dev and Chandra (Moon). As the sign of Cancer, it perfectly channels the energy of emotional peace, mental clarity, and domestic harmony.</p>
                    <p>When Chandra (Moon) is weak or afflicted in your horoscope, it can cause significant obstacles. This tailored ritual pacifies these malefic placements.</p>
                    <p>The puja is traditionally performed to invoke purely auspicious energies, featuring specific Chandra (Moon) Beej Mantras and sacred offerings to clear karmic blockages.</p>
                </div>
            </section>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Kark (Cancer) Puja?</h2>
                    <div className="sp-why-grid">
                        <div className="sp-why-card">
                            <h4>💫 Astrological Alignment</h4>
                            <p>Corrects doshas and negative transits directly impacting the Cancer moon sign or ascendant.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🎯 Career Breakthroughs</h4>
                            <p>Removes unseen obstacles severely blocking your professional and financial emotional peace, mental clarity, and domestic harmony.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🧘 Inner Peace</h4>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Kark (Cancer) Puja</h2>
                ...
                <div className="sp-container">
                    ...
                    <div className="sp-stairs">
                        {[
                            ...
                            { num: 2, icon: '🙏', title: 'Avahana', sub: 'Invoking Lord Shiva and Chandra Dev with ancient Vedic mantras' },
                            { num: 3, icon: '🌸', title: 'Shodashopachar', sub: 'Offering milk, rice, and white flowers and sacred items' },
                            { num: 4, icon: '📖', title: 'Mantra Japa', sub: 'Chanting Om Shram Shrim Shraum Sah Chandraya Namah' },
                            { num: 5, icon: '🔥', title: 'Sacred Havan', sub: 'Fire ritual with kheer and white sesame' },
                            { num: 6, icon: '💧', title: 'Shanti Path', sub: 'Vedic prayers to stabilize the calming and emotional energy' },
                            { num: 7, icon: '🎁', title: 'Aarti & Prasad', sub: 'Sending you energized silver/pearl and divine blessings' },
                        ].map((s, i) => (
