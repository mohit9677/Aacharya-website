...
const PUJA_ID = 'makar-sankranti-pongal-puja'
const PUJA_NAME = 'Makar Sankranti / Pongal'
        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Makar Sankranti / Pongal</h1>
                    <p>[Hero description for Makar Sankranti / Pongal will go here. This provides the primary benefits and calling.]</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Makar Sankranti / Pongal?</h2>
                    <p>[Detailed description of what Makar Sankranti / Pongal is, its Vedic significance, and the main deity or cosmic energy involved. Add specific context here later.]</p>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Makar Sankranti / Pongal?</h2>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Makar Sankranti / Pongal</h2>
