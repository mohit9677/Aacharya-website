        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Makar (Capricorn) Puja</h1>
                    <p>Attain career milestones, discipline, massive structural success, and reward for hard work and invite divine blessings into your life. Shani (Saturn) governs Capricorn; balancing its energy unlocks profound cosmic benefits.</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Makar (Capricorn) Puja?</h2>
                    <p>Makar (Capricorn) Puja is a powerful Vedic ritual dedicated to Lord Shiva and Shani Dev and Shani (Saturn). As the sign of Capricorn, it perfectly channels the energy of career milestones, discipline, massive structural success, and reward for hard work.</p>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Makar (Capricorn) Puja?</h2>
                    <div className="sp-why-grid">
                        <div className="sp-why-card">
                            <h4>💫 Astrological Alignment</h4>
                            <p>Corrects doshas and negative transits directly impacting the Capricorn moon sign or ascendant.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🎯 Career Breakthroughs</h4>
                            <p>Removes unseen obstacles severely blocking your professional and financial career milestones, discipline, massive structural success, and reward for hard work.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🧘 Inner Peace</h4>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Makar (Capricorn) Puja</h2>
