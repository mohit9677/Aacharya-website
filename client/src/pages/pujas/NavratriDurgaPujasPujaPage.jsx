...
const PUJA_ID = 'navratri-durga-pujas-puja'
const PUJA_NAME = 'Navratri & Durga Pujas'
        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Navratri & Durga Pujas</h1>
                    <p>[Hero description for Navratri & Durga Pujas will go here. This provides the primary benefits and calling.]</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Navratri & Durga Pujas?</h2>
                    <p>[Detailed description of what Navratri & Durga Pujas is, its Vedic significance, and the main deity or cosmic energy involved. Add specific context here later.]</p>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Navratri & Durga Pujas?</h2>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Navratri & Durga Pujas</h2>
