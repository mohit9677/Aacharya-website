...
const PUJA_ID = 'karwa-chauth-puja'
const PUJA_NAME = 'Karwa Chauth Puja'
        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Karwa Chauth Puja</h1>
                    <p>[Hero description for Karwa Chauth Puja will go here. This provides the primary benefits and calling.]</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Karwa Chauth Puja?</h2>
                    <p>[Detailed description of what Karwa Chauth Puja is, its Vedic significance, and the main deity or cosmic energy involved. Add specific context here later.]</p>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Karwa Chauth Puja?</h2>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Karwa Chauth Puja</h2>
