        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Tula (Libra) Puja</h1>
                    <p>Attain harmony, successful partnerships, justice, and artistic fame and invite divine blessings into your life. Shukra (Venus) governs Libra; balancing its energy unlocks profound cosmic benefits.</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Tula (Libra) Puja?</h2>
                    <p>Tula (Libra) Puja is a powerful Vedic ritual dedicated to Goddess Lakshmi and Shukracharya and Shukra (Venus). As the sign of Libra, it perfectly channels the energy of harmony, successful partnerships, justice, and artistic fame.</p>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Tula (Libra) Puja?</h2>
                    <div className="sp-why-grid">
                        <div className="sp-why-card">
                            <h4>💫 Astrological Alignment</h4>
                            <p>Corrects doshas and negative transits directly impacting the Libra moon sign or ascendant.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🎯 Career Breakthroughs</h4>
                            <p>Removes unseen obstacles severely blocking your professional and financial harmony, successful partnerships, justice, and artistic fame.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🧘 Inner Peace</h4>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Tula (Libra) Puja</h2>
