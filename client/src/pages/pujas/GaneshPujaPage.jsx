...
import heroImage from '../../Marriage/ganesh puja.webp'
import pujaImage from '../../Marriage/ganesh puja (2).webp'
import mandalaImage from '../../Marriage/ganesh puja.webp'
import './LakshmiPraptiStyle.css'

const PUJA_ID = 'ganesh-puja'
const PUJA_NAME = 'Ganesh Puja'
...
const PACKAGES = [
  ...
  {
    id: 'premium',
    name: 'Divya Ganesh Puja Anushthan',
    price: 21100,
    duration: '5-6 hours',
...
const REASONS = [
  "People perform Ganesh Puja before any new beginning — business launch, marriage, construction, or travel — to ensure divine clearance of every obstacle on their path.",
  "Students perform this puja before exams and competitive tests, seeking Lord Ganesha's blessings for sharp memory, clear thinking, and academic excellence.",
  "Professionals facing career stagnation, job loss, or business failure perform this puja to re-energise their purpose and attract new opportunities with divine force.",
  "Families perform Ganesh Puja during Ganesh Chaturthi and auspicious occasions to invite peace, unity, prosperity, and divine intelligence into their household and relationships.",
  "Entrepreneurs invoke Lord Ganesha to unlock creative intelligence, find breakthrough solutions, and navigate complex business challenges with wisdom and grace.",
  "Spiritual seekers perform daily Ganesh Puja to purify their mind, dissolve karmic blockages, and accelerate their spiritual awakening and self-realisation journey."
]
const BENEFITS = [
  {
    "title": "Benefit 1",
    "desc": "Removes all known and unknown obstacles from your path, making the journey to success smooth and effortless."
  },
  {
    "title": "Benefit 2",
    "desc": "Sharpens intellect, enhances decision-making power, and grants exceptional wisdom in all areas of life."
  },
  {
    "title": "Benefit 3",
    "desc": "Creates divine protection around new ventures, relationships, and investments, shielding them from failure."
  },
  {
    "title": "Benefit 4",
    "desc": "Brings harmony to family and social relationships, dissolving misunderstandings and ego-driven conflicts."
  },
  {
    "title": "Benefit 5",
    "desc": "Enhances creativity, innovative thinking, and the ability to find unique solutions to life's toughest problems."
  },
  {
    "title": "Benefit 6",
    "desc": "Accelerates spiritual progress, deepens meditation experiences, and cleanses karmic debts from past lives."
  }
]
const PROCESS = [
  {
    "title": "Select an auspicious day",
    "sub": "Ganesh Chaturthi, Wednesday, or any Shukla Paksha (waxing moon) date for maximum blessings."
  },
  {
    "title": "Purify the puja space with Ganga Jal and place a",
    "sub": "Purify the puja space with Ganga Jal and place a clean cloth or banana leaf as the base for the deity."
  },
  {
    "title": "Establish the Ganesh idol or image on the altar,",
    "sub": "Establish the Ganesh idol or image on the altar, ensuring the trunk is turned left (Vamamukhi) for worldly blessings."
  },
  {
    "title": "Perform Prana Pratishtha by chanting 'Om Gam Gan",
    "sub": "Perform Prana Pratishtha by chanting 'Om Gam Ganapataye Namaha' 21 times to invoke life force into the idol."
  },
  {
    "title": "Offer durva grass (Ganesha's most beloved offeri",
    "sub": "Offer durva grass (Ganesha's most beloved offering), red hibiscus flowers, and modak (sweet dumplings)."
  },
  {
    "title": "Light a ghee lamp and 5 incense sticks, symbolis",
    "sub": "Light a ghee lamp and 5 incense sticks, symbolising the five elements and creating a divine sensory experience."
  },
  {
    "title": "Perform abhishekam (sacred bath) using milk, hon",
    "sub": "Perform abhishekam (sacred bath) using milk, honey, curd, Ganga Jal, and rose water."
  }
]
      ...
      <section className="lp-hero" id="top">
        ...
        <div className="lp-container lp-hero-grid">
          <div className="lp-hero-content">
            ...
            <h1>Ganesh <span>Puja</span></h1>
            {MANTRA ? (
              <p className="lp-mantra">{MANTRA}</p>
            ) : (
              <p className="lp-mantra" style={{ opacity: 0.7 }}>ॐ शुभं भवतु</p>
            )}
            <p className="lp-subtitle">Ganesh Puja is the most fundamental and universally performed ritual in Hindu tradition — a sacred offering of love and devotion to Lord Ganesha, the elephant-headed son of Lord Shiva and Goddess Parvati. Known as Vighna…</p>
          ...
          <div className="lp-hero-art">
            ...
            <img src={heroImage} alt="Ganesh Puja" />
      ...
      <section className="lp-section lp-about">
        <div className="lp-container lp-about-grid">
          <div className="lp-about-image-wrap">
            <img src={pujaImage} alt="Ganesh Puja setup" className="lp-about-image" />
          ...
          <div className="lp-about-copy">
            ...
            <p>Ganesh Puja is the most fundamental and universally performed ritual in Hindu tradition — a sacred offering of love and devotion to Lord Ganesha, the elephant-headed son of Lord Shiva and Goddess Parvati. Known as Vighnaharta (the remover of obstacles), Ganapati (the lord of all beings), and Buddhidata (the bestower of wisdom), Lord Ganesha is invoked at the beginning of every important endeavour in life. From starting a new business to buying a home, from beginning studies to embarking on a journey — Ganesha's ble…</p>
            <p>Why devotees perform it: People perform Ganesh Puja before any new beginning — business launch, marriage, construction, or travel — to ensure divine clearance of every obstacle on their path.</p>
