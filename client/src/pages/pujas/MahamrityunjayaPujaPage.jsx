...
const PUJA_ID = 'mahamrityunjaya-puja'
const PUJA_NAME = 'Mahamrityunjaya Puja'
...
const PACKAGES = [
    {
        ...
        features: ['Basic Rudrabhishek', 'Mahamrityunjaya Japa', 'Small Havan', 'Live video of puja', 'Prasad sent to home'],
    },
    {
        id: 'vishesh',
        sanskrit: 'विशेष पूजा',
        ...
        features: ['Full Rudrabhishek with Panchamrit', 'Sankalp in your name & gotra', 'Detailed Havan with Bilva', 'Live HD video', 'Prasad + Rudraksha + Sacred ash', 'Personal phone consultation'],
        popular: true,
    },
    {
        id: 'maha',
        ...
        features: ['Sava Lakh Mantra Anushthan', 'Ekadash Rudrabhishek', 'Grand Havan with 108 Bilva', 'Full ceremony recording', 'Premium prasad hamper', 'Energised Rudraksha mala', '30-day pandit guidance'],
    },
]

const BENEFITS = [
    { icon: <FiHeart />, title: 'Healing & Recovery', desc: 'Aids recovery from chronic illness, surgery, and prolonged ailments.' },
    { icon: <FiShield />, title: 'Protection from Harm', desc: 'Shields you and your loved ones from accidents, fear, and untimely danger.' },
    { icon: <FiSun />, title: 'Long, Healthy Life', desc: 'Blesses life with vitality, mental peace, and longevity (Ayushya).' },
    { icon: <FiStar />, title: 'Removes Negativity', desc: 'Dissolves doshas, planetary afflictions, and karmic burdens.' },
    { icon: <FiHeart />, title: 'Inner Peace', desc: 'Calms the mind, reduces anxiety, and awakens deep spiritual courage.' },
    { icon: <FiShield />, title: 'Spiritual Purification', desc: 'Purifies the subtle body and clears the path toward liberation.' },
]

const REASONS = [
    'Recovery from a serious illness, surgery, or accident',
    'When a family member is suffering from prolonged sickness',
    'To remove fear of untimely death (Mrityu Bhaya)',
    'On birthdays and Janma Nakshatra for long life',
    'During difficult dasha, sade sati, or severe graha dosha',
    'For protection of children and elders in the family',
]

const STEPS = [
    { n: '01', title: 'Sankalp & Purification', text: 'The devotee takes a sacred vow and the puja space is purified with Ganga jal and mantras.' },
    { n: '02', title: 'Kalash & Ganesh Pujan', text: 'Lord Ganesha is invoked first, followed by sacred Kalash sthapana.' },
    { n: '03', title: 'Rudrabhishek', text: 'Shiva Lingam is bathed with panchamrit, milk, honey, curd, ghee, and holy water.' },
    { n: '04', title: 'Mantra Japa', text: 'Mahamrityunjaya mantra chants are done with Vedic precision and sankalp.' },
    { n: '05', title: 'Havan & Ahuti', text: 'Sacred fire offerings with bilva, samagri, and ghee complete the ritual.' },
    { n: '06', title: 'Aarti & Prasad', text: 'The puja concludes with Shiva aarti and blessed prasad dispatch.' },
]
        ...
        <div className="mm-page">
            ...
            <section className="mm-hero" style={{ '--mm-hero-image': `url(${heroImage})` }}>
                ...
                <div className="mm-hero-content">
                    ...
                    <h1>Mahamrityunjaya <span>Puja</span></h1>
                    <p className="mm-quote">Conqueror of Death, Giver of Eternal Life</p>
                    <p className="mm-subtitle">
                        When illness lingers and fear overshadows your loved ones, invoke Lord Shiva through the most powerful Vedic mantra for health, peace, and longevity.
                    </p>
            ...
            <section className="mm-mantra">
                <h2>ॐ त्र्यम्बकं यजामहे सुगन्धिं पुष्टिवर्धनम्।<br />उर्वारुकमिव बन्धनान्मृत्योर्मुक्षीय माऽमृतात्॥</h2>
                <p>"We worship the three-eyed Lord. May He liberate us from the bondage of death and grant immortal grace."</p>
            </section>
            ...
            <section className="mm-section">
                <div className="mm-container mm-about">
                    <div>
                        ...
                        <h2>What is the Mahamrityunjaya Puja?</h2>
                        <p>
                            Mahamrityunjaya Puja is one of the most revered rituals of Sanatan Dharma, devoted to Lord Shiva as the Conqueror of Death. It invokes healing, protection, and deep inner strength.
                        </p>
                        <p>
                            Rooted in Rig Veda and Yajur Veda traditions, this puja combines mantra japa, Rudrabhishek, and havan to reduce suffering and support complete wellbeing of body, mind, and spirit.
                        </p>
                    </div>
                    <img src={shivaImage} alt="Sacred temple and Lord Shiva symbolism" />
                </div>
            </section>
            ...
            <footer className="mm-footer">
                ...
                <p>May Lord Shiva bless you with health, happiness, and a long life.</p>
