        ...
        <div className="sp-page">
            ...
            >
                <div className="sp-hero-overlay">
                    ...
                    <h1>Dhanu (Sagittarius) Puja</h1>
                    <p>Attain higher education, spiritual luck, fortune, and global travel and invite divine blessings into your life. Guru (Jupiter) governs Sagittarius; balancing its energy unlocks profound cosmic benefits.</p>
            ...
            <section className="sp-section sp-about">
                <div className="sp-container">
                    ...
                    <h2>What is Dhanu (Sagittarius) Puja?</h2>
                    <p>Dhanu (Sagittarius) Puja is a powerful Vedic ritual dedicated to Lord Vishnu and Brihaspati and Guru (Jupiter). As the sign of Sagittarius, it perfectly channels the energy of higher education, spiritual luck, fortune, and global travel.</p>
                    <p>When Guru (Jupiter) is weak or afflicted in your horoscope, it can cause significant obstacles. This tailored ritual pacifies these malefic placements.</p>
                    <p>The puja is traditionally performed to invoke purely auspicious energies, featuring specific Guru (Jupiter) Beej Mantras and sacred offerings to clear karmic blockages.</p>
                </div>
            </section>
            ...
            <section className="sp-section sp-why">
                <div className="sp-container">
                    ...
                    <h2>Why Do People Perform Dhanu (Sagittarius) Puja?</h2>
                    <div className="sp-why-grid">
                        <div className="sp-why-card">
                            <h4>💫 Astrological Alignment</h4>
                            <p>Corrects doshas and negative transits directly impacting the Sagittarius moon sign or ascendant.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🎯 Career Breakthroughs</h4>
                            <p>Removes unseen obstacles severely blocking your professional and financial higher education, spiritual luck, fortune, and global travel.</p>
                        </div>
                        <div className="sp-why-card">
                            <h4>🧘 Inner Peace</h4>
            ...
            <section className="sp-section sp-benefits">
                <div className="sp-container">
                    ...
                    <h2>Benefits of Dhanu (Sagittarius) Puja</h2>
                ...
                <div className="sp-container">
                    ...
                    <div className="sp-stairs">
                        {[
                            ...
                            { num: 2, icon: '🙏', title: 'Avahana', sub: 'Invoking Lord Vishnu and Brihaspati with ancient Vedic mantras' },
                            { num: 3, icon: '🌸', title: 'Shodashopachar', sub: 'Offering yellow flowers and turmeric and sacred items' },
                            { num: 4, icon: '📖', title: 'Mantra Japa', sub: 'Chanting Om Gram Grim Graum Sah Gurave Namah' },
                            { num: 5, icon: '🔥', title: 'Sacred Havan', sub: 'Fire ritual with yellow pulses and ghee' },
                            { num: 6, icon: '💧', title: 'Shanti Path', sub: 'Vedic prayers to stabilize the expansive and wise energy' },
                            { num: 7, icon: '🎁', title: 'Aarti & Prasad', sub: 'Sending you energized gold/brass and divine blessings' },
                        ].map((s, i) => (
