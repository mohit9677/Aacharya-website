...
import heroImg from '../../Marriage/sagittarius.webp';
import yantraImg from '../../Marriage/sagittarius (2).webp';
import havanImg from '../../Marriage/sagittarius (3).webp';
import './MeshPujaStyle.css';

const PUJA_ID   = 'dhanu-puja';
const PUJA_NAME = 'Dhanu (Sagittarius) Puja';
...
const benefits = [
  {
    "icon": Shield,
    "title": "Brings extraordinary wisdom",
    "desc": "Brings extraordinary wisdom, divine fortune, and spiritual grace, transforming the native's life into an abundantly blessed and purposeful spiritual adventure."
  },
  {
    "icon": Heart,
    "title": "Ensures academic excellence",
    "desc": "Ensures academic excellence, success in higher education, and opens pathways to prestigious foreign opportunities, international careers, and global recognition."
  },
  {
    "icon": Briefcase,
    "title": "Attracts powerful teachers",
    "desc": "Attracts powerful teachers, enlightened gurus, and divine mentors who accelerate the native's intellectual and spiritual growth exponentially."
  },
  {
    "icon": Users,
    "title": "Heals liver disorders",
    "desc": "Heals liver disorders, hip problems, obesity, and issues related to excessive indulgence through Jupiter's divine healing and balancing energy."
  },
  {
    "icon": Flame,
    "title": "Brings legal victories",
    "desc": "Brings legal victories, divine justice, and favorable outcomes in court cases, ﬁnancial settlements, and all matters of righteous resolution."
  },
  {
    "icon": Sparkles,
    "title": "Accelerates spiritual awakening",
    "desc": "Accelerates spiritual awakening, deepens meditation practices, and opens access to higher dimensions of divine wisdom and cosmic truth."
  }
]
;
...
const steps = [
  {
    "n": "01",
    "title": "puja space with the energy of",
    "desc": "puja space with the energy of a student entering the greatest classroom in the cosmos."
  },
  {
    "n": "02",
    "title": "yellow silk cloth",
    "desc": "yellow silk cloth — this altar is your personal portal to Jupiter's inﬁnite wisdom."
  },
  {
    "n": "03",
    "title": "golden-yellow spectrum of abundance, wisdom, and",
    "desc": "golden-yellow spectrum of abundance, wisdom, and grace."
  },
  {
    "n": "04",
    "title": "wisdom, and divine blessings from every",
    "desc": "wisdom, and divine blessings from every corner of the universe."
  },
  {
    "n": "05",
    "title": "energy expanding your consciousness like a",
    "desc": "energy expanding your consciousness like a universe exploding into magniﬁcent being."
  },
  {
    "n": "06",
    "title": "opens every door of cosmic fortune",
    "desc": "opens every door of cosmic fortune simultaneously in your life."
  },
  {
    "n": "07",
    "title": "honoring knowledge during his puja multiplies",
    "desc": "honoring knowledge during his puja multiplies his blessings a thousandfold."
  },
  {
    "n": "08",
    "title": "feeding wisdom-keepers the highest act of",
    "desc": "feeding wisdom-keepers the highest act of devotion."
  },
  {
    "n": "09",
    "title": "invest in another soul's wisdom and",
    "desc": "invest in another soul's wisdom and education."
  }
];
const whyPoints = [
  "People perform Dhanu Rashi Puja to receive Jupiter's supreme blessings of wisdom, fortune, and spiritual grace that transform ordinary lives into extraordinary, abundantly blessed spiritual journeys.",
  "Students and teachers perform this puja for academic excellence, philosophical depth, and success in higher education, including foreign universities and prestigious professional examinations globally.",
  "People seeking foreign travel, immigration, settlement abroad, or international career opportunities perform this puja as Jupiter governs long-distance travel and blesses the native with global success.",
  "Those involved in law, judiciary, religious institutions, or spiritual teaching perform this puja to receive Jupiter's divine guidance, righteous authority, and success in their noble calling.",
  "When Jupiter is weak or aﬄicted — causing ﬁnancial losses, educational setbacks, or spiritual disconnection — this puja is performed to fully restore Guru's divine blessings immediately.",
  "Individuals seeking spiritual awakening, guru-disciple relationships, and access to higher esoteric knowledge perform this puja to open the celestial doorway to divine wisdom and enlightenment."
];
...
export default function DhanuPujaPage() {
    ...
    <div className="mesh-puja-theme">
      <section className="mp-hero">
        <div className="mp-hero__bg">
          <img src={heroImg} alt="Dhanu (Sagittarius) Puja hero" />
          ...
          <div className="mp-hero__inner">
            <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration:0.8 }}>
              ...
              <h1 className="mp-serif mp-hero__title">
                Awaken Sagittarius.<br />
                <span className="mp-hero__title-accent">Align Dhanu.</span>
              </h1>
              <p className="mp-hero__desc mp-sans">
                Dhanu Rashi Puja is a magniﬁcent and wisdom-ﬁlled V edic ritual for those born under the Sagittarius zodiac sign. Governed by the great teacher Jupiter (Guru/Brihaspati) — the most auspicious and expansive of all planets — this puja invokes Lord Vishnu and Lor…
              </p>
          ...
          <div className="mp-about__grid">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.8, delay:0.1 }}>
              ...
              <h2 className="mp-section-title">
                What is the<br /><span style={{ fontStyle:'italic' }}>Dhanu Puja?</span>
              </h2>
              <div className="mp-about__body mp-sans">
                <p>Dhanu Rashi Puja is a magniﬁcent and wisdom-ﬁlled V edic ritual for those born under the Sagittarius zodiac sign. Governed by the great teacher Jupiter (Guru/Brihaspati) — the most auspicious and expansive of all planets — this puja invokes Lord Vishnu and Lord Brihaspati to shower the native with boundless wisdom, higher learning, spiritual enlightenment, and extraordinary fortune.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="benefits" className="mp-section mp-section--muted" style={{ position:'relative' }}>
        ...
        <div className="mp-container" style={{ position:'relative' }}>
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-text-center mp-max-2xl mp-mb-16">
            ...
            <p className="mp-section-sub">People perform Dhanu Rashi Puja to receive Jupiter's supreme blessings of wisdom, fortune, and spiritual grace that transform ordinary lives into extraordinary, abundantly blessed spiritual journeys.</p>
          </motion.div>
        ...
        <div className="mp-container">
          <div className="mp-process__grid">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }} transition={{ duration:0.7 }} className="mp-process__sticky">
              ...
              <p className="mp-section-sub" style={{ marginBottom:'2rem' }}>puja space with the energy of a student entering the greatest classroom in the cosmos.</p>
