...
export default function Navbar() {
    ...
    const mockPujas = [
        ...
        { id: 2, title: "Chandra (Moon) Puja", category: "planet", icon: <GiMoon />, desc: "For emotional balance." },
        { id: 3, title: "Mangal (Mars) Puja", category: "planet", icon: <GiMaceHead />, desc: "Enhance courage and strength." },
        { id: 4, title: "Budh (Mercury) Puja", category: "planet", icon: <GiBookAura />, desc: "Boost intellect and speech." },
        { id: 5, title: "Guru (Jupiter) Puja", category: "planet", icon: <GiScrollUnfurled />, desc: "Attract wisdom and luck." },
        { id: 6, title: "Shukra (Venus) Puja", category: "planet", icon: <GiLotusFlower />, desc: "For luxury and romance." },
        { id: 7, title: "Shani (Saturn) Puja", category: "planet", icon: <GiCrowDive />, desc: "Overcome hurdles and karma." },
        { id: 8, title: "Rahu Puja", category: "planet", icon: <GiCobra />, desc: "Pacify sudden disruptions." },
        { id: 9, title: "Ketu Puja", category: "planet", icon: <GiSnake />, desc: "For spiritual growth." },
        { id: 10, title: "Navgraha Shanti Puja", category: "planet", icon: <GiCircleSparks />, desc: "Pacify the nine planets." },

        // Zodiac (Rashi) Pujas
        { id: 11, title: "Mesh (Aries) Puja", category: "zodiac", icon: <GiAries />, desc: "Aries alignment correction." },
        { id: 12, title: "Vrishabh (Taurus) Puja", category: "zodiac", icon: <GiTaurus />, desc: "Taurus specific rituals." },
        { id: 13, title: "Mithun (Gemini) Puja", category: "zodiac", icon: <GiGemini />, desc: "Gemini specific rituals." },
        { id: 14, title: "Kark (Cancer) Puja", category: "zodiac", icon: <GiCancer />, desc: "Cancer harmony puja." },
        { id: 15, title: "Singh (Leo) Puja", category: "zodiac", icon: <GiLeo />, desc: "Leo specific rituals." },
        { id: 16, title: "Kanya (Virgo) Puja", category: "zodiac", icon: <GiVirgo />, desc: "Virgo specific alignment." },
        { id: 17, title: "Tula (Libra) Puja", category: "zodiac", icon: <GiLibra />, desc: "Libra specific harmony." },
        { id: 18, title: "Vrishchik (Scorpio) Puja", category: "zodiac", icon: <GiScorpio />, desc: "Scorpio specific rituals." },
        { id: 19, title: "Dhanu (Sagittarius) Puja", category: "zodiac", icon: <GiSagittarius />, desc: "Sagittarius alignment." },
        { id: 20, title: "Makar (Capricorn) Puja", category: "zodiac", icon: <GiCapricorn />, desc: "Capricorn specific harmony." },
        { id: 21, title: "Kumbh (Aquarius) Puja", category: "zodiac", icon: <GiAquarius />, desc: "Aquarius specific rituals." },
        { id: 22, title: "Meen (Pisces) Puja", category: "zodiac", icon: <GiPisces />, desc: "Pisces alignment correction." },

        // Wealth & Career Pujas
        { id: 23, title: "Lakshmi Prapti Puja", category: "wealth", icon: <GiBarefoot />, desc: "Attract unending prosperity." },
        { id: 24, title: "Lakshmi Kubera Puja", category: "wealth", icon: <GiCoins />, desc: "Magnetize material wealth." },
        { id: 25, title: "Ganesh Puja", category: "wealth", icon: <GiElephantHead />, desc: "For success & obstacle removal." },
        { id: 26, title: "Business Growth Puja", category: "wealth", icon: <GiTargetPrize />, desc: "Accelerate business success." },
        { id: 27, title: "Career / Job Success Puja", category: "wealth", icon: <GiTargetPrize />, desc: "Achieve professional milestones." },
        { id: 28, title: "Dhan Yog Activation Puja", category: "wealth", icon: <GiGoldNuggets />, desc: "Activate wealth combinations." },
        { id: 29, title: "Financial Stability Puja", category: "wealth", icon: <GiScales />, desc: "Ensure steady income flow." },

        // Relationship & Marriage Pujas
        { id: 30, title: "Vivah (Marriage) Puja", category: "relationship", icon: <GiLoveMystery />, desc: "Blessings for a holy union." },
        { id: 31, title: "Love Marriage Puja", category: "relationship", icon: <GiLovers />, desc: "Remove marriage obstacles." },
        { id: 32, title: "Relationship Healing Puja", category: "relationship", icon: <GiHeartBeats />, desc: "Restore emotional bonds." },
        { id: 33, title: "Compatibility (Kundli Milan) Puja", category: "relationship", icon: <GiScrollQuill />, desc: "Harmonize astrological charts." },
        { id: 34, title: "Breakup Recovery Puja", category: "relationship", icon: <GiHealing />, desc: "Inner peace and moving on." },
        { id: 35, title: "Delay in Marriage Puja", category: "relationship", icon: <GiHourglass />, desc: "Speed up the marriage process." },

        // Health & Protection Pujas
        { id: 36, title: "Mahamrityunjaya Puja", category: "health", icon: <GiTrident />, desc: "For ultimate health & longevity." },
        { id: 37, title: "Health Recovery Puja", category: "health", icon: <GiHealing />, desc: "Speedy recovery from illness." },
        { id: 38, title: "Nazar Dosh (Evil Eye) Removal Puja", category: "health", icon: <GiEvilEyes />, desc: "Cleanse negative influences." },
        { id: 39, title: "Protection / Energy Shield Puja", category: "health", icon: <GiShield />, desc: "Secure aura from harm." },
        { id: 40, title: "Negative Energy Removal Puja", category: "health", icon: <GiVortex />, desc: "Purify mind, body & surroundings." },

        // Dosha Nivaran
        { id: 41, title: "Kaal Sarp Dosh Puja", category: "dosha", icon: <GiSnakeSpiral />, desc: "Remove Kaal Sarp obstacles." },
        { id: 42, title: "Pitra Dosh Puja", category: "dosha", icon: <GiCandleLight />, desc: "Blessings from ancestors." },
        { id: 43, title: "Mangal Dosh Puja", category: "dosha", icon: <GiFireBowl />, desc: "Nullify Mars negative effects." },
        { id: 44, title: "Shani Dosh Puja", category: "dosha", icon: <GiRaven />, desc: "Resolve Saturn karmic delays." },
        { id: 45, title: "Grahan Dosh Puja", category: "dosha", icon: <GiEclipse />, desc: "Cure eclipse-born flaws." },
        { id: 46, title: "Vastu Dosh Puja", category: "dosha", icon: <GiHouse />, desc: "Correct home energy imbalances." },
        
        // Special / Festival Pujas
        { id: 47, title: "Diwali Pujas", category: "special", icon: <GiCandleFlame />, desc: "Prosperity & light celebrations." },
        { id: 48, title: "Ganesh Chaturthi Pujas", category: "special", icon: <GiElephant />, desc: "Welcoming Lord Ganesha." },
        { id: 49, title: "Navratri & Durga Pujas", category: "special", icon: <GiTrident />, desc: "Awaken divine feminine power." },
        { id: 50, title: "Makar Sankranti / Pongal", category: "special", icon: <GiSun />, desc: "Harvest blessings and growth." },
        { id: 51, title: "Chhath Puja", category: "special", icon: <GiSunRadiations />, desc: "Honoring the Sun God." },
        { id: 52, title: "Maha Shivratri Pujas", category: "special", icon: <GiTrident />, desc: "Night of Lord Shiva." },
        { id: 53, title: "Saraswati Puja", category: "special", icon: <GiMusicalScore />, desc: "Wisdom, arts, & learning." },
        { id: 54, title: "Karwa Chauth Puja", category: "special", icon: <GiMoon />, desc: "For longevity of spouse." }
    ];
